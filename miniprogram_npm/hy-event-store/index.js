...
__DEFINE__(1717494307744, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1717494307745,"./event-store":1717494307746}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1717494307745, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1717494307746, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1717494307745,"./utils":1717494307747}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1717494307747, function(require, module, exports) {
...
return __REQUIRE__(1717494307744);
})()
